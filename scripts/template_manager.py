    ...
    def archive_template(self, keyword, version=None):
        ...
        with self.driver.session() as session:
            ...
            if version:
                ...
                if is_current:
                    logger.error(f"Cannot archive current version. Please update to a new version first.")
                    return False
    ...
    try:
        if args.command == 'list':
            ...
            if template:
                ...
                print(f"Template not found: '{args.keyword}'{' v' + args.version if args.version else ''}")
            ...
            if manager.export_template(args.keyword, args.output, args.version):
                ...
                print(f"Failed to export template")
            ...
            if manager.archive_template(args.keyword, args.version):
                ...
                print(f"Failed to archive template")
            ...
            if manager.import_directory(args.input_dir, args.as_new_version):
                ...
                print(f"Failed to import templates")
