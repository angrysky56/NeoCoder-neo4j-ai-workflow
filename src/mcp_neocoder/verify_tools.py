...
def check_incarnation_types():
    ...
    try:
        ...
        # Import IncarnationType from the correct module if not in base_incarnation
        try:
            from mcp_neocoder.incarnations.base_incarnation import IncarnationType
        except ImportError:
            # Try importing from another likely location
            from mcp_neocoder.incarnations.incarnation_type import IncarnationType
